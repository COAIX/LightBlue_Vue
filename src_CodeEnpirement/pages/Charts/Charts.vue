<template>
  <div class="charts-overview">
    ...
    <el-button @click="testlivecharts"></el-button>
  </div>
</template>
...
export default {
  ...
  methods:{
    testlivecharts(){
      ...
      this.ld.series[0].data.push({x:(new Date()).getTime(),y:1});
      this.ld.series[0].data.push({x:(new Date()).getTime(),y:0});
      console.log(this.ld.series[0].data);
    }
  },
  computed: {
    sparklineData() {

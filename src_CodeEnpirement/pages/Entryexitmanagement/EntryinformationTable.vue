<template>
    <Widget title="<h5>入校信息 <small class='text-muted'>黑龙江大学</small></h5>" customHeader close collapse>
        <!-- 内容 -->
...
<script>
    ...
    export default { //暴露以便外界可以接收到
        name: 'EntryinformationTable', //与文件名一致
        components: {
            Widget
        ...
        methods: {
            ...
            getTableDataWithCheck() {
                axios.get('http://127.0.0.1:8086/entryinformation/getAll').then(
                    response => {
                        //回调函数

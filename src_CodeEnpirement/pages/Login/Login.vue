<template>
  <div class="auth-page">
    <b-container>
      <Widget class="widget-auth mx-auto" title="<h3 class='mt-0'>LOGIN TO HLJU WEB SYSTEM</h3>" customHeader>
        <p class="widget-auth-info">
          Use your HLJU email to sign in.
        </p>
          ...
          <b-form-group label="Email" label-for="email">
            <b-input-group>
              ...
              <input id="email"
                     ...
                     required
                     placeholder="Email"/>
                <!-- <input type="text" class="form-control input-transparent pl-3"> -->
            </b-input-group>
          </b-form-group>
